## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Kubernetes Helm Release CRD`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the CRDOpenAPI API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Operator.Helm.OpenAPI                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | haskell-helm-operator-client                    |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Operator.Helm.OpenAPI.Client    | use the "dispatch" functions to send requests       |
| Operator.Helm.OpenAPI.Core      | core funcions, config and request types             |
| Operator.Helm.OpenAPI.API       | construct api requests                              |
| Operator.Helm.OpenAPI.Model     | describes api models                                |
| Operator.Helm.OpenAPI.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Operator.Helm.OpenAPI.ModelLens | lenses for model fields                             |
| Operator.Helm.OpenAPI.Logging   | logging functions and utils                         |
